 ...
 */
	...
	#include "version.h"
	#ifndef REPO_VERSION
		#define REPO_VERSION STRINGIFY(REPO_MAJOR_VERSION) "." STRINGIFY(REPO_MINOR_VERSION) "." STRINGIFY(REPO_PATCH_VERSION) " on " STRINGIFY(FORM_BUILD_OSVER) " " STRINGIFY(FORM_BUILD_ARCH) " [" STRINGIFY(FORM_BUILD_TYPE) " build]"
	#endif
	#ifndef REPO_DATE
	...
	#define FORM_BUILD_OSVER REPO_BUILD_OSNAME
    #define FORM_BUILD_ARCH REPO_BUILD_ARCH
    #define FORM_BUILD_TYPE REPO_BUILD_TYPE
#else
	/*
